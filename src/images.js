export const images = [
    ...
    },
    {
      ...
      description: 'Try to perform, perfection is not the only goal',
      originalAlt: 'Try to perform, perfection is not the only goal',
    ...
    },
    {
      ...
      description: 'समत्व (balance) is the key',
      originalAlt: 'समत्व (balance) is the key',
